...
public:
    SST_ELI_DECLARE_STATISTIC_TEMPLATE_DERIVED(LogBinHistogramStatistic, BinDataType, "sst", "LogBinHistogramStatistic",
        SST_ELI_ELEMENT_VERSION(1, 0, 0), "Track distribution of statistic across bins", "SST::Statistic<T>")
    ...
    ~LogBinHistogramStatistic() override = default;

    LogBinHistogramStatistic() = default;  // For serialization ONLY
